...
const ReviewsPage = () => {
  ...
  const fetchReviewsArticles = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/articles/category/reviews`);
  ...
  return (
    <div className={styles.reviewsPage}>
      <div className={styles.pageHeader}>
        <h1>Reviews</h1>
        <p>Analysis, commentary, and expert reviews</p>
      </div>
      ...
      <div className={styles.featuredSection}>
        <div className={styles.adColumn}>
          <AdvertisementSlot page="reviews" index={0} className={styles.adBox} />
        </div>
        ...
        <div className={styles.adColumn}>
          <AdvertisementSlot page="reviews" index={1} className={styles.adBox} />
        </div>
      </div>

      {/* Mobile Ads */}
      <div className={styles.mobileAds}>
        <AdvertisementSlot page="reviews" index={2} className={styles.adBox} />
      </div>
